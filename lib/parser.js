...
function peg$parse(input, options) {
  ...
  function peg$f9(key, value) {    addNode(node('Assign', value, location(), key))  }
  function peg$f10(key, value) {    addNode(node('Assign', value, location(), key))  }
  ...
  function peg$f23(left, right) {    return node('Float', parseFloat(left + 'e' + right), location())  }
  function peg$f24(text) {    return node('Float', parseFloat(text), location())  }
  function peg$f25(digits) {    return digits.join('')  }
  function peg$f26(digits) {    return '-' + digits.join('')  }
  function peg$f27(text) {    return node('Integer', parseInt(text, 10), location())  }
  function peg$f28(digits) {    return digits.join('')  }
  function peg$f29(digits) {    return '-' + digits.join('')  }
  function peg$f30() {    return node('Boolean', true, location())  }
  function peg$f31() {    return node('Boolean', false, location())  }
  function peg$f32() {    return node('Array', [], location())  }
  function peg$f33(value) {    return node('Array', value ? [value] : [], location())  }
  function peg$f34(values) {    return node('Array', values, location())  }
  function peg$f35(values, value) {    return node('Array', values.concat(value), location())  }
  function peg$f36(value) {    return value  }
  function peg$f37(value) {    return value  }
  function peg$f38(values) {    return node('InlineTable', values, location())  }
  function peg$f39(key, value) {    return node('InlineTableValue', value, location(), key)  }
  function peg$f40(key, value) {    return node('InlineTableValue', value, location(), key)  }
  function peg$f41(digits) {    return "." + digits  }
  function peg$f42(date) {    return  date.join('')  }
  function peg$f43(time) {    return time.join('')  }
  function peg$f44(time) {    return time.join('')  }
  function peg$f45(date, time) {    return node('Date', new Date(date + "T" + time + "Z"), location())  }
  function peg$f46(date, time) {    return node('Date', new Date(date + "T" + time), location())  }
  function peg$f47() {    return ""  }
  function peg$f48(d) {    return d.join('')  }
  function peg$f49() {    return '"'  }
  function peg$f50() {    return '\\'  }
  function peg$f51() {    return '\b'  }
  function peg$f52() {    return '\t'  }
  function peg$f53() {    return '\n'  }
  function peg$f54() {    return '\f'  }
  function peg$f55() {    return '\r'  }
  function peg$f56(digits) {    return convertCodePoint(digits.join(''))  }
  function peg$f57(digits) {    return convertCodePoint(digits.join(''))  }
