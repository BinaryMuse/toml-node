...
function peg$parse(input, options) {
  ...
  const peg$e21 = peg$literalExpectation("T", false);
  const peg$e22 = peg$literalExpectation("Z", false);
  ...
  function peg$f22(left, right) {    return node('Float', parseFloat(left + 'e' + right), location())  }
  function peg$f23(text) {    return node('Float', parseFloat(text), location())  }
  function peg$f24(digits) {    return digits.join('')  }
  function peg$f25(digits) {    return '-' + digits.join('')  }
  function peg$f26(text) {    return node('Integer', parseInt(text, 10), location())  }
  function peg$f27(digits) {    return digits.join('')  }
  function peg$f28(digits) {    return '-' + digits.join('')  }
  function peg$f29() {    return node('Boolean', true, location())  }
  function peg$f30() {    return node('Boolean', false, location())  }
  function peg$f31() {    return node('Array', [], location())  }
  function peg$f32(value) {    return node('Array', value ? [value] : [], location())  }
  function peg$f33(values) {    return node('Array', values, location())  }
  function peg$f34(values, value) {    return node('Array', values.concat(value), location())  }
  function peg$f35(value) {    return value  }
  function peg$f36(value) {    return value  }
  function peg$f37() {    return node('InlineTable', [], location())  }
  function peg$f38(entries, last) {    return node('InlineTable', entries.concat(last), location())  }
  function peg$f39(entry) {    return node('InlineTable', [entry], location())  }
  function peg$f40(e) {    return e  }
  function peg$f41(entries) {    return entries  }
  function peg$f42(keys, value) {    return node('InlineTableValue', value, location(), keys)  }
  function peg$f43(parts, last) {    return parts.concat(last)  }
  function peg$f44(k) {    return [k]  }
  function peg$f45(k) {    return k  }
  function peg$f46(digits) {    return "." + digits  }
  function peg$f47(date) {    return  date.join('')  }
  function peg$f48(time) {    return time.join('')  }
  function peg$f49(time) {    return time.join('')  }
  function peg$f50(date, time) {    return node('Date', new Date(date + "T" + time + "Z"), location())  }
  function peg$f51(date, time) {    return node('Date', new Date(date + "T" + time), location())  }
  function peg$f52() {    return ""  }
  function peg$f53(d) {    return d.join('')  }
  function peg$f54() {    return '"'  }
  function peg$f55() {    return '\\'  }
  function peg$f56() {    return '\b'  }
  function peg$f57() {    return '\t'  }
  function peg$f58() {    return '\n'  }
  function peg$f59() {    return '\f'  }
  function peg$f60() {    return '\r'  }
  function peg$f61(digits) {    return convertCodePoint(digits.join(''))  }
  function peg$f62(digits) {    return convertCodePoint(digits.join(''))  }
